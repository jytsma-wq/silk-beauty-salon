      ...
      <div className="mx-auto max-w-7xl px-8 py-24 md:py-32">
        <div className="mb-20 max-w-3xl md:mb-32">
          ...
          <h2 className="mb-6 font-sans text-4xl font-light text-stone-900 md:text-5xl lg:text-6xl">
            {tNewsletter('title', { defaultValue: 'Join Our World' })}
          </h2>
          ...
          <form className="flex max-w-lg flex-col gap-4 sm:flex-row" onSubmit={handleNewsletterSubmit}>
            ...
            <button
              ...
              className="bg-stone-900 px-8 py-4 text-sm uppercase tracking-wide text-stone-50 transition-colors hover:bg-[#765946] disabled:cursor-not-allowed disabled:opacity-60"
            >
              {isSubmitting
        ...
        <div className="mb-16 grid grid-cols-2 gap-8 md:grid-cols-4 md:gap-12 lg:grid-cols-6">
          <div className="col-span-2">
            ...
            <div className="mt-8 flex gap-6">
              <a
                ...
                className="text-stone-600 transition-colors hover:text-[#765946]"
          ...
          <div className="col-span-2">
            ...
            <address className="not-italic text-sm leading-relaxed text-stone-600">
              ...
              <p className="mb-3">
                <a href={`tel:${siteConfig.contact.phone}`} className="transition-colors hover:text-[#765946]">
                  {siteConfig.contact.phone}
                </a>
              </p>
              <p>
                <a href={`mailto:${siteConfig.contact.email}`} className="transition-colors hover:text-[#765946]">
        ...
        <div className="border-t border-stone-200 pt-8">
          <div className="flex flex-col gap-6 text-[0.68rem] font-medium uppercase tracking-[0.28em] text-stone-700 lg:flex-row lg:items-center lg:justify-between">
