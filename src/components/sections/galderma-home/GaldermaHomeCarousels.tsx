...
function CarouselButton({
  ...
  const t = useTranslations('homeEditorial.carousel');
              ...
              <div className="grid min-h-[calc(100svh-152px)] grid-cols-1 lg:grid-cols-[46%_54%]">
                <div className="order-2 flex items-center px-6 py-14 md:px-12 md:py-16 lg:order-1 lg:px-16 xl:px-24">
                  <div className="max-w-xl">
                    <p className="mb-5 text-[0.68rem] font-medium uppercase tracking-[0.28em] text-[#795b45]">
                      {slide.eyebrow}
                    </p>
...
export function ResultsCarousel() {
  ...
  return (
    <div>
                ...
                <div>
                  <div className="relative aspect-3/4 overflow-hidden bg-stone-100">
                    <Image
                      ...
                      sizes="(max-width: 768px) 46vw, 24vw"
                    />
                    <span className="absolute bottom-0 left-0 bg-[#795b45] px-4 py-2 text-[0.62rem] uppercase tracking-[0.18em] text-white">
                      {t('results.after')}
                    </span>
                  </div>
                </div>
      ...
      <p className="mt-8 text-center text-[0.68rem] uppercase tracking-[0.16em] text-stone-600">
          ...
          {articles.map((article) => (
            ...
            >
              <Link href={article.href} className="group block">
                ...
                <p className="mt-5 text-[0.68rem] uppercase tracking-[0.22em] text-[#795b45]">
                  {article.category}
                </p>
