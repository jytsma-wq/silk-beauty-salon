...
function SectionHeading({
  ...
  return (
    <div className="max-w-3xl">
      <p className="mb-4 text-[0.68rem] font-medium uppercase tracking-[0.28em] text-[#795b45]">
        {eyebrow}
      </p>
          ...
          {items.map((item) => (
            <Link key={item.title} href={item.href} className="group bg-white">
              ...
              <div className="min-h-56 p-7 md:p-9">
                ...
                <span className="mt-7 inline-block text-[0.68rem] font-medium uppercase tracking-[0.2em] text-[#795b45]">
                  {t('portfolio.explore')}
                </span>
              </div>
            </Link>
